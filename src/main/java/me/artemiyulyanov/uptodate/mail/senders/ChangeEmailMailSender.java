...
public class ChangeEmailMailSender implements MailSender {
    ...
    public MailConfirmationCode send(String email, List<MailConfirmationCode.Credential> credentials) {
        MailConfirmationCode confirmationCode = MailConfirmationCode.builder()
                ...
                .scope(MailConfirmationCode.MailScope.EMAIL_CHANGE)
                .build();
        ...
        message.setText(String.format("Hi! Your confirmation code is: %s. Enter it to change your email", confirmationCode.getCode()));
