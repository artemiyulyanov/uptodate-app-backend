...
@AllArgsConstructor
@Component
public class ChangeEmailMailSender implements MailSender {
...
//                .sentAt(LocalDateTime.now())
                .scope(MailConfirmationMessage.MailScope.EMAIL_CHANGE)
                .build();
        ...
        message.setText(String.format("Hi! Follow this confirmation link to change your password: %s", changeEmailMailMessageUrl + mailConfirmationMessage.getId()));
